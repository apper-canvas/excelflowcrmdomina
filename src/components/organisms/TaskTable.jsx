    ...
    <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
                <tr>
                    <th
                        ...
                        <div className="flex items-center">Task
                    ...
                    <th
                        ...
                        <div className="flex items-center">Priority
                    ...
                    <th
                        className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Contact/Deal
                                      </th>
                    <th
            ...
            <tbody className="bg-white divide-y divide-gray-200">
                {tasks.map((task, index) => <motion.tr
                    key={task.Id}
                    initial={{
                        opacity: 0,
                        y: 20
                    ...
                    <td className="px-6 py-4">
                        <div className="cursor-pointer" onClick={() => onTaskClick(task)}>
                            ...
                            {task.description && <div
                                className={cn(
                                    "text-sm mt-1 truncate max-w-xs",
                                    task.status === "completed" ? "line-through text-gray-400" : "text-gray-500"
                                )}>
                                {task.description}
                            </div>}
                            {task.status === "completed" && task.completedAt && <div className="text-xs text-green-600 mt-1">Completed {format(new Date(task.completedAt), "MMM d, yyyy 'at' h:mm a")}
                            </div>}
                        </div>
                    </td>
